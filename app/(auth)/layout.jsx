export default function AuthLayout({ children }) {
  return (
    <div className="flex min-h-svh flex-col items-center justify-center bg-[#0a0a0a] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-orange-900/20 via-[#0a0a0a] to-[#0a0a0a] p-4 md:p-10 relative overflow-hidden">
